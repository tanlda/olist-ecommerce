...
def ecommerce_sync_products_etl():
    @task(task_id="upload_landing")
    def upload_landing_products():
        import polars as pl
    ...
    def sync_lakehouse_products():
        ...
        response = minio.get_object("ecommerce", "landing/products/products.csv")
    ...
    upload_landing = upload_landing_products()
    sync_lakehouse = sync_lakehouse_products()
    sync_warehouse = sync_warehouse_products()

    upload_landing >> sync_lakehouse >> sync_warehouse


ecommerce_sync_products_etl()
