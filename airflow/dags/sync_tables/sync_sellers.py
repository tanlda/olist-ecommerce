...
def ecommerce_sync_sellers_etl():
    @task(task_id="upload_landing")
    def upload_landing_sellers():
        import polars as pl
    ...
    def sync_lakehouse_sellers():
        ...
        response = minio.get_object("ecommerce", "landing/sellers/sellers.csv")
    ...
    upload_landing = upload_landing_sellers()
    sync_lakehouse = sync_lakehouse_sellers()
    sync_warehouse = sync_warehouse_sellers()

    upload_landing >> sync_lakehouse >> sync_warehouse


ecommerce_sync_sellers_etl()
